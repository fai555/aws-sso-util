...
@click.option("--sso-start-url", metavar="URL", help="Your AWS SSO start URL")
@click.option("--sso-region", metavar="REGION", help="The AWS region your AWS SSO instance is deployed in")
@click.option("--account-id", "account", metavar="ACCOUNT", help="The AWS account", required=True)
@click.option("--role-name", "role", metavar="ROLE", help="The SSO role to assume in account", required=True)
